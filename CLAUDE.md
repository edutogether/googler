...
- **2026-09-10~: 정기감사 라운드 진행 중.** 대표님이 org 전체 순서(문서 정리 → 종합감사 100 → 배포 → 프리즈 태그)를 지시 — 2026-09-02~09-30 실운영 모드 방침(그대로 `_docs/archive/operational-mode-20260902.md`에 보존)은 이 지시로 대체됐다. 아래 "정기감사 라운드" 섹션 참고.
...
- 전시 프리즈 최신 태그: `googler-freeze-20260908-docs` — 복구 절차 전체는 `_docs/ops/freeze-recovery.md`.
- 개인정보처리방침: `public/privacy.html`, 라이브 `https://googler.edutogether.kr/privacy.html`.

## 정기감사 라운드 (2026-09-10 시작, 대표 지시로 실운영 모드 대체)

org 전체가 "문서 정리 → 종합감사 100 → 배포 → 프리즈 태그" 순서로 도는 라운드에 이 저장소도 포함됐다. 진행 상황과 최종 점수는 `_docs/CHANGELOG.md`에 이 라운드가 끝나는 대로 기록한다. 지난 2026-09-02 §7 종합감사(Sonnet+Opus 독립 조사, A트랙 10개 항목 100점)의 전체 내용은 `_docs/archive/operational-mode-20260902.md`와 `_docs/CHANGELOG.md`의 해당 섹션에 그대로 있다.
